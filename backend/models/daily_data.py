...
class DailyData(Base):
    ...
    return_13d = Column(Float)
    return_20d = Column(Float)
    return_60d = Column(Float)
    return_mid = Column(Float)
    vol_ma3 = Column(Float)
    vol_ma5 = Column(Float)
    vol_ma13 = Column(Float)
    vol_ma30 = Column(Float)
    is_30d_high = Column(Float)
    is_10d_high = Column(Float)
    ma5_slope3 = Column(Float)
    close_above_ma5_5d = Column(Float)
    last_close_above_ma5 = Column(Float)
    pattern_tags = Column(Text, default="[]")
